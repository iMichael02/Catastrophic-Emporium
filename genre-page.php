                            ...
                            <div class="grid-item">
                                <div class="grid-item-container">
                                    ...
                                    <div class="grid-item-shopping-options">
                                        ...
                                        <form action="./genre-page.php" id="add-to-wishlist-form" method="post">
                    ...
                    <div class="page-nav">
                        <ul class="page-nav-container" id="page-nav-container">
                            ...
                            for ($i = 1; $i <= $pages; $i++) {
                                if ($page == $i) {
                                    ?>
                                    <li class="page-nav-item selected"><a href="./genre-page.php?id=<?php echo $genre->_id ?>&page=<?php
                                    echo $i;
                                    if (isset($_GET['type'])) {
                                    ...
                                    ?>
                                    <li class="page-nav-item"><a href="./genre-page.php?id=<?php echo $genre->_id ?>&page=<?php
                                    echo $i;
                                    if (isset($_GET['type'])) {
                                        foreach($_GET['type'] as $index => $submit_type) {
                                            echo "&type%5B".$index."%5D=".$submit_type;

...
if (isset($_POST['add_to_wishlist'])) {
    if (isset($_SESSION['uid'])) {
        ...
        $updated_wishlist = (array)($online_member->wishlist);
        if (array_search($pid, $updated_wishlist) != false) {
...
<body>
    <div class="page-wrapper">
        ...
        <!-- Main Content -->
        <div class="main-content-store" style="background: url('./images/background/homebg.png');
                            ...
                            <div class="grid-item">
                                <div class="grid-item-container">
                                    ...
                                    <div class="grid-item-title">
                                        <?php
                                        $band = $bands->findOne(['_id' => $products_list[$i]->band_id]);
                                        echo $band->name;
                                        ?>
                                    </div>
                                    ...
                                    <div class="grid-item-shopping-options">
                                        ...
                                        <form action="./store.php" id="add-to-wishlist-form" method="post">
                    ...
                    <div class="page-nav">
                        <ul class="page-nav-container" id="page-nav-container">
                            ...
                            for ($i = 1; $i <= $pages; $i++) {
                                if ($page == $i) {
                                    ?>
                                    <li class="page-nav-item selected"><a href="./store.php?page=<?php
                                    echo $i;
                                    if (isset($_GET['type'])) {
                                    ...
                                    ?>
                                    <li class="page-nav-item"><a href="./store.php?page=<?php
                                    echo $i;
                                    if (isset($_GET['type'])) {
                                        foreach($_GET['type'] as $index => $submit_type) {
                                            echo "&type%5B".$index."%5D=".$submit_type;
